...
`,yt=document.createElement("link");function wt(t){if(t.attributes.icon)return t.attributes.icon;const e=t.entity_id.split(".")[0],i=t.state;return{light:"on"===i?"mdi:lightbulb":"mdi:lightbulb-outline",switch:"on"===i?"mdi:toggle-switch":"mdi:toggle-switch-off",fan:"mdi:fan",climate:"mdi:thermostat",weather:xt(i),sensor:$t(t),binary_sensor:"on"===i?"mdi:checkbox-marked-circle":"mdi:checkbox-blank-circle-outline",cover:"open"===i?"mdi:window-open":"mdi:window-closed",lock:"locked"===i?"mdi:lock":"mdi:lock-open",media_player:"playing"===i?"mdi:play-circle":"mdi:play-circle-outline",alarm_control_panel:Ct(i),camera:"mdi:video",automation:"mdi:robot",script:"mdi:script-text",scene:"mdi:palette",input_boolean:"on"===i?"mdi:check-circle":"mdi:close-circle",person:"mdi:account",device_tracker:"mdi:crosshairs-gps",vacuum:"mdi:robot-vacuum",input_number:"mdi:ray-vertex",input_select:"mdi:format-list-bulleted",timer:"mdi:timer-outline",counter:"mdi:counter",sun:"above_horizon"===i?"mdi:white-balance-sunny":"mdi:weather-night"}[e]||"mdi:help-circle-outline"}function xt(t){return{"clear-night":"mdi:weather-night",cloudy:"mdi:weather-cloudy",fog:"mdi:weather-fog",hail:"mdi:weather-hail",lightning:"mdi:weather-lightning","lightning-rainy":"mdi:weather-lightning-rainy",partlycloudy:"mdi:weather-partly-cloudy",pouring:"mdi:weather-pouring",rainy:"mdi:weather-rainy",snowy:"mdi:weather-snowy","snowy-rainy":"mdi:weather-snowy-rainy",sunny:"mdi:weather-sunny",windy:"mdi:weather-windy","windy-variant":"mdi:weather-windy-variant",exceptional:"mdi:alert-circle-outline"}[t]||"mdi:weather-cloudy"}function $t(t){return{temperature:"mdi:thermometer",humidity:"mdi:water-percent",pressure:"mdi:gauge",power:"mdi:flash",energy:"mdi:lightning-bolt",battery:"mdi:battery",illuminance:"mdi:brightness-6",carbon_dioxide:"mdi:molecule-co2",carbon_monoxide:"mdi:molecule-co",gas:"mdi:gas-cylinder",moisture:"mdi:water",signal_strength:"mdi:wifi",voltage:"mdi:sine-wave",current:"mdi:current-ac"}[t.attributes.device_class]||"mdi:eye"}function Ct(t){return{armed_home:"mdi:shield-home",armed_away:"mdi:shield-lock",armed_night:"mdi:shield-moon",armed_vacation:"mdi:shield-airplane",armed_custom_bypass:"mdi:shield-star",disarmed:"mdi:shield-off",triggered:"mdi:bell-ring",pending:"mdi:shield-alert",arming:"mdi:shield-outline"}[t]||"mdi:shield"}function St(t){return["on","open","playing","home","unlocked"].includes(t)}function Et(t,e){const i=t.state,s=t.attributes.unit_of_measurement;return s?`${i} ${s}`:i}function At(t,e){const i=49297*Math.sin(9301*t+49297*e+233280);return i-Math.floor(i)}function Pt(t,e,i,s,a,n,r=4){const o=i-t,c=s-e,l=Math.sqrt(o*o+c*c);if(l<8)return`L ${i.toFixed(1)} ${s.toFixed(1)}`;const h=Math.max(2,Math.floor(l/35));let d="";for(let i=1;i<=h;i++){const s=i/h,p=t+o*s,u=e+c*s;if(i<h){const t=-c/l,e=o/l,s=(At(a,13*n+i)-.5)*r*2;d+=`L ${(p+t*s).toFixed(1)} ${(u+e*s).toFixed(1)} `}else d+=`L ${p.toFixed(1)} ${u.toFixed(1)} `}return d}function Tt(t,e,i,s,a,n=5,r=0,o=0){const c=t+r,l=e+r,h=t+i-r,d=e+s-r,p=Math.min(o,(h-c)/3,(d-l)/3),u=t=>(At(a,t+50)-.5)*n*.6;if(p<=1){let t=`M ${(c+u(0)).toFixed(1)} ${(l+u(1)).toFixed(1)} `;return t+=Pt(c+u(0),l+u(1),h+u(2),l+u(3),a,0,n),t+=Pt(h+u(2),l+u(3),h+u(4),d+u(5),a,1,n),t+=Pt(h+u(4),d+u(5),c+u(6),d+u(7),a,2,n),t+=Pt(c+u(6),d+u(7),c+u(0),l+u(1),a,3,n),t+="Z",t}const g=t=>(At(a,t+80)-.5)*n*.3;let m=`M ${(c+p+g(0)).toFixed(1)} ${(l+g(1)).toFixed(1)} `;return m+=Pt(c+p+g(0),l+g(1),h-p+g(2),l+g(3),a,0,n),m+=`Q ${(h+g(4)).toFixed(1)} ${(l+g(5)).toFixed(1)} ${(h+g(6)).toFixed(1)} ${(l+p+g(7)).toFixed(1)} `,m+=Pt(h+g(6),l+p+g(7),h+g(8),d-p+g(9),a,1,n),m+=`Q ${(h+g(10)).toFixed(1)} ${(d+g(11)).toFixed(1)} ${(h-p+g(12)).toFixed(1)} ${(d+g(13)).toFixed(1)} `,m+=Pt(h-p+g(12),d+g(13),c+p+g(14),d+g(15),a,2,n),m+=`Q ${(c+g(16)).toFixed(1)} ${(d+g(17)).toFixed(1)} ${(c+g(18)).toFixed(1)} ${(d-p+g(19)).toFixed(1)} `,m+=Pt(c+g(18),d-p+g(19),c+g(20),l+p+g(21),a,3,n),m+=`Q ${(c+g(22)).toFixed(1)} ${(l+g(23)).toFixed(1)} ${(c+p+g(0)).toFixed(1)} ${(l+g(1)).toFixed(1)} `,m+="Z",m}function zt(t,e,i={}){const{bgColor:s="var(--sketch-card-bg, var(--ha-card-background, #faf7f0))",strokeColor:a="var(--sketch-border-color, var(--primary-text-color, #2a2a2a))",showBorder:n=!0,showTexture:r=!0,noiseOpacity:o=.08,seed:c=0,variant:l="paper"}=i,h=`sn${c}${Math.floor(1e4*At(c,999))}`;let d=`<svg class="sketch-bg-svg" viewBox="0 0 ${t} ${e}" preserveAspectRatio="none" xmlns="http://www.w3.org/2000/svg">`;r&&(d+=`<defs>\n      <filter id="${h}" x="0" y="0" width="100%" height="100%">\n        <feTurbulence type="fractalNoise" baseFrequency="0.5" numOctaves="4" seed="${c}" stitchTiles="stitch" result="noise"/>\n        <feColorMatrix type="saturate" values="0" in="noise" result="gray"/>\n      </filter>\n    </defs>`);if(d+=`<path d="${Tt(0,0,t,e,c,3,3,14)}" fill="${s}" />`,r&&(d+=`<rect x="0" y="0" width="${t}" height="${e}" filter="url(#${h})" opacity="${o}" style="mix-blend-mode:multiply" />`),"notebook"===l?d+=function(t,e,i){let s="";const a=28,n=50;for(let i=45;i<e-15;i+=a){const e=.5*Math.sin(.1*i);s+=`<line x1="${n+5}" y1="${i+e}" x2="${t-15}" y2="${i-.5*e}" stroke="#90c1d4" stroke-width="0.8" opacity="0.35" />`}s+=`<line x1="${n}" y1="8" x2="${n+.5}" y2="${e-8}" stroke="#d4626a" stroke-width="1.8" opacity="0.35" />`,s+=`<line x1="${n+2.5}" y1="8" x2="${n+2}" y2="${e-8}" stroke="#d4626a" stroke-width="0.8" opacity="0.18" />`;const r=Math.min(6,Math.floor((e-40)/45));for(let t=0;t<r;t++){const e=35+45*t;s+=`<circle cx="22" cy="${e}" r="5" fill="var(--sketch-card-bg, var(--ha-card-background, #faf7f0))" />`,s+=`<circle cx="22" cy="${e}" r="5" fill="none" stroke="${i}" stroke-width="1.2" opacity="0.3" />`,s+=`<circle cx="22.5" cy="${e+.5}" r="4" fill="none" stroke="${i}" stroke-width="0.5" opacity="0.15" />`}return s}(t,e,a):"sticky"===l&&(d+=function(t){const e=t/2,i=Math.min(90,.3*t);return`<g opacity="0.55" transform="rotate(${(2*Math.sin(.1*e)-1).toFixed(1)} ${e} 6)">\n    <rect x="${e-i/2}" y="-4" width="${i}" height="20" fill="#e8e4c8" rx="1" />\n    <line x1="${e-i/2+4}" y1="2" x2="${e+i/2-4}" y2="2" stroke="#c8c4a8" stroke-width="0.4" opacity="0.4" />\n    <line x1="${e-i/2+4}" y1="8" x2="${e+i/2-4}" y2="8" stroke="#c8c4a8" stroke-width="0.4" opacity="0.4" />\n  </g>`}(t)),n){d+=`<path d="${Tt(0,0,t,e,c,5,6,14)}" fill="none" stroke="${a}" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round" opacity="0.65" />`;d+=`<path d="${Tt(0,0,t,e,c+17,4,7.8,14)}" fill="none" stroke="${a}" stroke-width="1.0" stroke-linecap="round" stroke-linejoin="round" opacity="0.22" />`}const p=Math.max(10,.07*Math.min(t,e)),u=11+2*At(c,70),g=11+2*At(c,71);d+=`<line x1="${u-.4*p}" y1="${g}" x2="${u+.4*p}" y2="${g}" stroke="${a}" stroke-width="1.2" opacity="0.3" stroke-linecap="round"/>`,d+=`<line x1="${u}" y1="${g-.4*p}" x2="${u}" y2="${g+.4*p}" stroke="${a}" stroke-width="1.2" opacity="0.3" stroke-linecap="round"/>`;const m=t-6-7+2*At(c,72),f=e-6-7+2*At(c,73),v=.35*p;d+=`<circle cx="${m}" cy="${f}" r="${v}" fill="none" stroke="${a}" stroke-width="1.1" opacity="0.28" />`,d+=`<path d="M ${m-.8*v} ${f-.3*v} A ${v} ${v} 0 0 1 ${m+.5*v} ${f+.8*v}" fill="none" stroke="${a}" stroke-width="0.7" opacity="0.18" />`;const k=Math.min(18,.045*t,.09*e),b=t-6-k;return d+=`<path d="M ${b} 6 L ${t-6} 6 L ${t-6} ${6+k} Z" fill="${a}" opacity="0.05" />`,d+=`<line x1="${b}" y1="6" x2="${t-6}" y2="${6+k}" stroke="${a}" stroke-width="0.8" opacity="0.18" stroke-linecap="round"/>`,d+="</svg>",d}function Mt(t){window.dispatchEvent(new CustomEvent("haptic",{detail:t}))}yt.rel="stylesheet",yt.href="https://fonts.googleapis.com/css2?family=Caveat:wght@400;600;700&family=Patrick+Hand&display=swap",document.head.querySelector('link[href*="Caveat"]')||document.head.appendChild(yt);class Nt extends lt{constructor(){super(...arguments),this._holdFired=!1,this._lastTap=0,this._prevState="",this.handleKeyDown=t=>{"Enter"!==t.key&&" "!==t.key||(t.preventDefault(),this.executeAction(this._config?.tap_action,this.defaultTapAction))},this.handlePointerDown=t=>{this._holdFired=!1,this._holdTimer=setTimeout(()=>{this._holdFired=!0,this._config?.hold_action&&(this.executeAction(this._config.hold_action),Mt("medium"))},500)},this.handlePointerUp=t=>{if(this._holdTimer&&(clearTimeout(this._holdTimer),this._holdTimer=void 0),this._holdFired)return;const e=Date.now();this._config?.double_tap_action&&e-this._lastTap<250?(this._dblTapTimer&&(clearTimeout(this._dblTapTimer),this._dblTapTimer=void 0),this._lastTap=0,this.executeAction(this._config.double_tap_action)):(this._lastTap=e,this._config?.double_tap_action?this._dblTapTimer=setTimeout(()=>{this._lastTap=0,this.executeAction(this._config?.tap_action,this.defaultTapAction)},250):this.executeAction(this._config?.tap_action,this.defaultTapAction))},this.handlePointerCancel=()=>{this._holdTimer&&(clearTimeout(this._holdTimer),this._holdTimer=void 0),this._holdFired=!1}}static{this.styles=[_t]}setConfig(t){if(!t)throw new Error("Invalid configuration");this._config={...t}}getCardSize(){return 3}renderSketchBg(t=400,e=200){const i=this._config;let s=0;const a=this._config?.entity||"";for(let t=0;t<a.length;t++)s=(s<<5)-s+a.charCodeAt(t)|0;return s=Math.abs(s),W`${bt(zt(t,e,{showBorder:!1!==i?.show_border,showTexture:!1!==i?.show_texture,variant:i?.variant||"paper",seed:s}))}`}getLayoutOptions(){return{grid_columns:4,grid_rows:this.getCardSize()}}getEntity(){if(this._config?.entity&&this.hass)return this.hass.states[this._config.entity]}isUnavailable(){const t=this.getEntity();return!!t&&["unavailable","unknown"].includes(t.state)}getName(){if(this._config?.name)return this._config.name;const t=this.getEntity();return t?.attributes?.friendly_name||this._config?.entity||""}getIcon(){if(this._config?.icon)return this._config.icon;const t=this.getEntity();return t?.attributes?.icon||"mdi:help-circle-outline"}async callService(t,e,i){try{await this.hass.callService(t,e,i)}catch(t){this.classList.add("sketch-error"),setTimeout(()=>this.classList.remove("sketch-error"),1e3),console.error("Ha-sketch service call failed:",t)}}toggleEntity(){if(!this._config?.entity)return;const[t]=this._config.entity.split(".");this.callService(t,"toggle",{entity_id:this._config.entity})}fireEvent(t,e){this.dispatchEvent(new CustomEvent(t,{bubbles:!0,composed:!0,detail:e}))}executeAction(t,e="more-info"){if(t?.confirmation&&!window.confirm("Are you sure?"))return;switch(t?.action||e){case"toggle":this.toggleEntity(),Mt("success");break;case"call-service":if(t?.service){const[e,i]=t.service.split(".");this.callService(e,i,t.service_data),Mt("light")}break;case"navigate":t?.navigation_path&&/^\/[a-zA-Z0-9\-_/?#=&.]*$/.test(t.navigation_path)&&(window.history.pushState(null,"",t.navigation_path),this.fireEvent("location-changed"),Mt("light"));break;case"url":t?.url_path&&(window.open(t.url_path,"_blank"),Mt("light"));break;case"none":break;default:this.fireEvent("hass-more-info",{entityId:this._config?.entity}),Mt("light")}}updated(t){var e,i;if(super.updated(t),t.has("_config")&&(e=this,i=this._config,i?.color?e.style.setProperty("--sketch-primary",i.color):e.style.removeProperty("--sketch-primary"),i?.card_background?e.style.setProperty("--sketch-card-bg",i.card_background):e.style.removeProperty("--sketch-card-bg"),i?.border_color?e.style.setProperty("--sketch-border-color",i.border_color):e.style.removeProperty("--sketch-border-color"),i?.card_rotation?e.style.setProperty("--sketch-card-rotate",i.card_rotation):e.style.removeProperty("--sketch-card-rotate")),t.has("hass")&&this.hass){const t=this.hass.themes?.darkMode??!1;this.classList.toggle("dark-mode",t);const e=this.isUnavailable();e&&!this.classList.contains("unavailable")?this.classList.add("unavailable"):!e&&this.classList.contains("unavailable")&&this.classList.remove("unavailable");const i=this.getEntity();if(i&&this._prevState&&i.state!==this._prevState){const t=this.shadowRoot?.querySelector("ha-card");t&&(t.style.animation="none",t.offsetHeight,t.style.animation="sketch-state-pulse 0.6s ease")}i&&(this._prevState=i.state)}}disconnectedCallback(){super.disconnectedCallback(),this._holdTimer&&clearTimeout(this._holdTimer),this._dblTapTimer&&clearTimeout(this._dblTapTimer)}get defaultTapAction(){return"more-info"}handleAction(){this.executeAction(this._config?.tap_action,this.defaultTapAction)}}t([gt({attribute:!1})],Nt.prototype,"hass",void 0),t([mt()],Nt.prototype,"_config",void 0);class jt extends lt{constructor(){super(...arguments),this._computeLabel=t=>({entity:"Entity",name:"Name (optional)",icon:"Icon (optional)",show_name:"Show Name",show_state:"Show State",show_icon:"Show Icon",show_brightness:"Show Brightness Slider",show_color_temp:"Show Color Temperature",show_current_as_primary:"Show Current Temp as Primary",show_forecast:"Show Forecast",num_forecasts:"Number of Forecast Days",graph:"Show Graph",show_artwork:"Show Artwork",show_source:"Show Source",show_position:"Show Position Slider",show_tilt:"Show Tilt Slider",show_location:"Show Location",show_battery:"Show Battery",battery_entity:"Battery Entity",show_controls:"Show Controls",aspect_ratio:"Aspect Ratio",hide_icon:"Hide Icon",states:"Alarm States",mode:"Display Mode",show_date:"Show Date",show_seconds:"Show Seconds",hash:"Hash (e.g. kitchen)",auto_close:"Auto-close (seconds)",width:"Width (e.g. 90%)",style:"Style",columns:"Columns",collapsible:"Collapsible",color:"Accent Color",card_background:"Card Background",border_color:"Border Color",card_rotation:"Rotation (e.g. -1deg, 0deg)",show_border:"Show Border",show_texture:"Show Paper Texture",variant:"Card Style"}[t.name]||t.name),this._valueChanged=t=>{const e=t.detail.value;!function(t,e,i){const s=new Event(e,{bubbles:!0,cancelable:!1,composed:!0});s.detail=i,t.dispatchEvent(s)}(this,"config-changed",{config:{...this._config,...e}})}}static{this.styles=[r`
  ...
  `]}get _defaults(){return{}}setConfig(t){this._config={...this._defaults,...t}}render(){return this.hass&&this._config?W`
    ...
    `}};Ot=t([dt("sketch-entity-card")],Ot);let Dt=class extends jt{get _defaults(){return{show_name:!0,show_state:!0,show_icon:!0}}get _schema(){return[...Lt()]}};Dt=t([dt("sketch-button-card-editor")],Dt);let Ht=class extends Nt{constructor(){super(...arguments),this._pressing=!1}static{this.styles=[...super.styles,r`
      .button-wrap {
        display: flex;
        flex-direction: column;
        align-items: center;
    ...
    `}};It=t([dt("sketch-light-card")],It);let Ft=class extends jt{get _defaults(){return{show_name:!0,show_state:!0,show_icon:!0,show_current_as_primary:!1}}get _schema(){return[...Lt("climate"),{name:"show_current_as_primary",selector:{boolean:{}}}]}};Ft=t([dt("sketch-thermostat-card-editor")],Ft);let Rt=class extends Nt{static{this.styles=[...super.styles,r`
      .thermo-header {
        display: flex;
        align-items: center;
        gap: 12px;
        ...
        <div class="sketch-card-content">
          <div class="thermo-header" role="button" tabindex="0" aria-label="${this.getName()}" @keydown=${this.handleKeyDown} @pointerdown=${this.handlePointerDown} @pointerup=${this.handlePointerUp} @pointercancel=${this.handlePointerCancel}>
            ...
            <div class="sketch-col">
              ...
              ${l?W`<p class="sketch-state">${r}</p>`:q}
            </div>
          </div>
    ...
    `}};Rt=t([dt("sketch-thermostat-card")],Rt);let Wt=class extends jt{get _defaults(){return{show_name:!0,show_state:!0,show_icon:!0,show_forecast:!0,num_forecasts:5}}get _schema(){return[...Lt("weather"),{name:"show_forecast",selector:{boolean:{}}},{name:"num_forecasts",selector:{number:{min:1,max:7,mode:"box"}}}]}};Wt=t([dt("sketch-weather-card-editor")],Wt);let Kt=class extends Nt{static{this.styles=[...super.styles,r`
      .weather-main {
        display: flex;
        align-items: center;
        gap: 16px;
      ...
      <ha-card>
        ...
        <div class="sketch-card-content">
          ...
          <div class="weather-details">
            ...
            ${null!=n?W`<div class="weather-detail"><ha-icon icon="mdi:weather-windy"></ha-icon>${n} ${r}</div>`:q}
            ${null!=o?W`<div class="weather-detail"><ha-icon icon="mdi:gauge"></ha-icon>${o} hPa</div>`:q}
          </div>
    ...
    `}};t([mt()],qt.prototype,"_history",void 0),qt=t([dt("sketch-sensor-card")],qt);let Vt=class extends jt{get _defaults(){return{show_name:!0,show_state:!0,show_icon:!0,show_artwork:!0,show_source:!0}}get _schema(){return[...Lt("media_player"),{name:"show_artwork",selector:{boolean:{}}},{name:"show_source",selector:{boolean:{}}}]}};Vt=t([dt("sketch-media-player-card-editor")],Vt);let Yt=class extends Nt{static{this.styles=[...super.styles,r`
      .media-layout {
        display: flex;
        gap: 14px;
        align-items: center;
      ...
      <ha-card>
        ...
        <div class="sketch-card-content">
          ...
          <div class="media-layout" role="button" tabindex="0" aria-label="${this.getName()}" @keydown=${this.handleKeyDown} @pointerdown=${this.handlePointerDown} @pointerup=${this.handlePointerUp} @pointercancel=${this.handlePointerCancel}>
            ${d&&r?s?W`<img class="media-artwork" src="${s}" alt="artwork" />`:W`
    ...
    `}};t([mt()],ee.prototype,"_config",void 0),t([mt()],ee.prototype,"_time",void 0),ee=t([dt("sketch-clock-card")],ee);let ie=class extends lt{constructor(){super(...arguments),this._config={}}static{this.styles=r`
    :host { display: block; }
    .editor-note {
      font-size: 13px;
      color: var(--secondary-text-color);
  ...
  `}setConfig(t){this._config={...t}}render(){return W`
    ...
    `}};t([gt({attribute:!1})],ie.prototype,"hass",void 0),t([mt()],ie.prototype,"_config",void 0),ie=t([dt("sketch-chip-card-editor")],ie);let se=class extends lt{static{this.styles=[_t,r`
      :host {
        display: block;
      }
      ha-card {
    ...
    `:q}};t([gt({attribute:!1})],se.prototype,"hass",void 0),t([mt()],se.prototype,"_config",void 0),se=t([dt("sketch-chip-card")],se);let ae=class extends jt{get _defaults(){return{show_name:!0,show_state:!0,show_icon:!0,show_location:!0,show_battery:!0}}get _schema(){return[...Lt("person"),{name:"show_location",selector:{boolean:{}}},{name:"show_battery",selector:{boolean:{}}},{name:"battery_entity",selector:{entity:{domain:"sensor"}}}]}};ae=t([dt("sketch-person-card-editor")],ae);let ne=class extends Nt{static{this.styles=[...super.styles,r`
      .person-row {
        display: flex;
        align-items: center;
        gap: 14px;
      ...
      <ha-card>
        ...
        <div class="sketch-card-content">
          <div class="person-row" role="button" tabindex="0" aria-label="${this.getName()}" @keydown=${this.handleKeyDown} @pointerdown=${this.handlePointerDown} @pointerup=${this.handlePointerUp} @pointercancel=${this.handlePointerCancel}>
            ${g?i?W`<img class="person-avatar" src="${i}" alt="${e}" />`:W`
    ...
    `}};ne=t([dt("sketch-person-card")],ne);let re=class extends jt{get _defaults(){return{show_name:!0,show_state:!0,show_icon:!0,hide_icon:!1}}get _schema(){return[...Lt(),{name:"hide_icon",selector:{boolean:{}}}]}};re=t([dt("sketch-tile-card-editor")],re);let oe=class extends Nt{static{this.styles=[...super.styles,r`
      ha-card {
        rotate: -0.3deg;
      }
      .tile-row {
    ...
    `}};t([mt()],le.prototype,"_imageUrl",void 0),t([mt()],le.prototype,"_loading",void 0),le=t([dt("sketch-camera-card")],le);let he=class extends jt{get _schema(){return[{name:"hash",selector:{text:{}}},{type:"grid",name:"",schema:[{name:"name",selector:{text:{}}},{name:"icon",selector:{icon:{}}}]},{name:"auto_close",selector:{number:{min:0,max:300,mode:"box"}}},{name:"width",selector:{text:{}}}]}render(){return this.hass&&this._config?W`
      ${super.render()}
      <p class="editor-note">
        Configure child cards in YAML mode (code editor).
      </p>
    `:q}};he=t([dt("sketch-popup-card-editor")],he);let de=class extends lt{constructor(){super(...arguments),this._open=!1,this._childCards=[],this._hashListener=()=>this._checkHash(),this._keyListener=t=>{"Escape"===t.key&&this._open&&this._closePopup()}}static{this.styles=[_t,r`
      :host {
        display: block;
      }
    ...
    `}};t([gt({attribute:!1})],de.prototype,"hass",void 0),t([mt()],de.prototype,"_config",void 0),t([mt()],de.prototype,"_open",void 0),t([mt()],de.prototype,"_childCards",void 0),de=t([dt("sketch-popup-card")],de);let pe=class extends lt{constructor(){super(...arguments),this._config={}}static{this.styles=r`
    :host { display: block; }
    .editor-note {
      font-size: 13px;
      color: var(--secondary-text-color);
  ...
  `}setConfig(t){this._config={...t}}render(){return W`
    ...
    `}};t([gt({attribute:!1})],pe.prototype,"hass",void 0),t([mt()],pe.prototype,"_config",void 0),pe=t([dt("sketch-horizontal-buttons-stack-editor")],pe);let ue=class extends lt{constructor(){super(...arguments),this._activeHash="",this._hashListener=()=>this._updateActiveHash()}static{this.styles=[_t,r`
      :host {
        display: block;
      }
      .nav-fixed {
    ...
    `}};t([gt({attribute:!1})],ue.prototype,"hass",void 0),t([mt()],ue.prototype,"_config",void 0),t([mt()],ue.prototype,"_activeHash",void 0),ue=t([dt("sketch-horizontal-buttons-stack")],ue);let ge=class extends jt{get _defaults(){return{show_name:!0,show_state:!0,show_icon:!0,columns:3,collapsible:!0}}get _schema(){return[...Lt(),{name:"columns",selector:{number:{min:1,max:6,mode:"box"}}},{name:"collapsible",selector:{boolean:{}}}]}render(){return this.hass&&this._config?W`
      ${super.render()}
      <p class="editor-note">
        Configure sub_buttons in YAML mode (code editor).
      </p>
    `:q}};ge=t([dt("sketch-sub-button-card-editor")],ge);let me=class extends Nt{constructor(){super(...arguments),this._expanded=!0}static{this.styles=[...super.styles,r`
      .primary-row {
        display: flex;
        align-items: center;
        gap: 12px;
        ...
        <div class="sketch-card-content">
          <div class="primary-row" role="button" tabindex="0" aria-label="${this.getName()}" @keydown=${this.handleKeyDown} @click=${n?this._toggleExpand:void 0} @pointerdown=${n?void 0:this.handlePointerDown} @pointerup=${n?void 0:this.handlePointerUp} @pointercancel=${n?void 0:this.handlePointerCancel}>
            ${c?W`
                ...
                `:q}
            <div class="sketch-col">
              ${r?W`<p class="sketch-name">${i}</p>`:q}
              ${o?W`<p class="sketch-state">${Et(t)}</p>`:q}
            </div>
    ...
    `}};t([mt()],me.prototype,"_expanded",void 0),me=t([dt("sketch-sub-button-card")],me);let fe=class extends jt{get _schema(){return[{name:"name",selector:{text:{}}},{name:"icon",selector:{icon:{}}},{type:"expandable",title:"Appearance",schema:[{type:"grid",name:"",schema:[{name:"color",selector:{ui_color:{}}},{name:"card_background",selector:{ui_color:{}}}]},{name:"border_color",selector:{ui_color:{}}},{name:"variant",selector:{select:{options:[{value:"paper",label:"Paper (default)"},{value:"notebook",label:"Notebook"},{value:"sticky",label:"Sticky Note"}],mode:"dropdown"}}},{name:"card_rotation",selector:{text:{}}},{name:"show_border",selector:{boolean:{}}},{name:"show_texture",selector:{boolean:{}}}]}]}};fe=t([dt("sketch-separator-card-editor")],fe);let ve=class extends lt{static{this.styles=[_t,r`
      :host {
        display: block;
      }
      ha-card {
    ...
    `}};be=t([dt("sketch-fan-card")],be);let _e=class extends jt{get _defaults(){return{show_name:!0,show_state:!0,show_icon:!0}}get _schema(){return[...Lt("lock")]}};_e=t([dt("sketch-lock-card-editor")],_e);let ye=class extends Nt{static{this.styles=[...super.styles,r`
      .lock-header {
        display: flex;
        align-items: center;
        gap: 12px;
    ...
    `}};ye=t([dt("sketch-lock-card")],ye);let we=class extends jt{get _defaults(){return{show_name:!0,show_state:!0,show_icon:!0,show_slider:!0}}get _schema(){return[...Lt(),{name:"show_slider",selector:{boolean:{}}}]}};we=t([dt("sketch-number-card-editor")],we);let xe=class extends Nt{static{this.styles=[...super.styles,r`
      .number-header {
        display: flex;
        align-items: center;
        gap: 12px;
        ...
        <div class="sketch-card-content">
          <div class="number-header" role="button" tabindex="0" aria-label="${this.getName()}" @keydown=${this.handleKeyDown} @pointerdown=${this.handlePointerDown} @pointerup=${this.handlePointerUp} @pointercancel=${this.handlePointerCancel}>
            ...
            <div class="sketch-col">
              ...
              ${o?W`<p class="sketch-state">${e}${n?` ${n}`:""}</p>`:q}
            </div>
          </div>
          ${l?W`
