...
`,vt=document.createElement("link");vt.rel="stylesheet",vt.href="https://fonts.googleapis.com/css2?family=Caveat:wght@400;600;700&family=Patrick+Hand&display=swap",document.head.querySelector('link[href*="Caveat"]')||document.head.appendChild(vt);class bt extends lt{constructor(){super(...arguments),this._holdFired=!1,this._lastTap=0}static{this.styles=[ft]}setConfig(t){if(!t)throw new Error("Invalid configuration");this._config={...t}}getCardSize(){return 3}getEntity(){if(this._config?.entity&&this.hass)return this.hass.states[this._config.entity]}isUnavailable(){const t=this.getEntity();return!!t&&["unavailable","unknown"].includes(t.state)}getName(){if(this._config?.name)return this._config.name;const t=this.getEntity();return t?.attributes?.friendly_name||this._config?.entity||""}getIcon(){if(this._config?.icon)return this._config.icon;const t=this.getEntity();return t?.attributes?.icon||"mdi:help-circle-outline"}callService(t,e,i){this.hass.callService(t,e,i)}toggleEntity(){if(!this._config?.entity)return;const[t]=this._config.entity.split(".");this.callService(t,"toggle",{entity_id:this._config.entity})}fireEvent(t,e){this.dispatchEvent(new CustomEvent(t,{bubbles:!0,composed:!0,detail:e}))}executeAction(t,e="more-info"){switch(t?.action||e){case"toggle":this.toggleEntity(),this.fireEvent("haptic",{type:"success"});break;case"call-service":if(t?.service){const[e,i]=t.service.split(".");this.callService(e,i,t.service_data),this.fireEvent("haptic",{type:"light"})}break;case"navigate":t?.navigation_path&&(window.history.pushState(null,"",t.navigation_path),this.fireEvent("location-changed"),this.fireEvent("haptic",{type:"light"}));break;case"url":t?.url_path&&(window.open(t.url_path,"_blank"),this.fireEvent("haptic",{type:"light"}));break;case"none":break;default:this.fireEvent("hass-more-info",{entityId:this._config?.entity}),this.fireEvent("haptic",{type:"light"})}}updated(t){super.updated(t),this.isUnavailable()?this.classList.add("unavailable"):this.classList.remove("unavailable")}get defaultTapAction(){return"more-info"}handleAction(){this.executeAction(this._config?.tap_action,this.defaultTapAction)}handlePointerDown(t){t.preventDefault(),this._holdFired=!1,this._holdTimer=setTimeout(()=>{this._holdFired=!0,this._config?.hold_action&&(this.executeAction(this._config.hold_action),this.fireEvent("haptic",{type:"medium"}))},500)}handlePointerUp(t){if(t.preventDefault(),this._holdTimer&&(clearTimeout(this._holdTimer),this._holdTimer=void 0),this._holdFired)return;const e=Date.now();this._config?.double_tap_action&&e-this._lastTap<250?(this._dblTapTimer&&(clearTimeout(this._dblTapTimer),this._dblTapTimer=void 0),this._lastTap=0,this.executeAction(this._config.double_tap_action)):(this._lastTap=e,this._config?.double_tap_action?this._dblTapTimer=setTimeout(()=>{this._lastTap=0,this.executeAction(this._config?.tap_action,this.defaultTapAction)},250):this.executeAction(this._config?.tap_action,this.defaultTapAction))}handlePointerCancel(){this._holdTimer&&(clearTimeout(this._holdTimer),this._holdTimer=void 0),this._holdFired=!1}}function kt(t){if(t.attributes.icon)return t.attributes.icon;const e=t.entity_id.split(".")[0],i=t.state;return{light:"on"===i?"mdi:lightbulb":"mdi:lightbulb-outline",switch:"on"===i?"mdi:toggle-switch":"mdi:toggle-switch-off",fan:"mdi:fan",climate:"mdi:thermostat",weather:yt(i),sensor:_t(t),binary_sensor:"on"===i?"mdi:checkbox-marked-circle":"mdi:checkbox-blank-circle-outline",cover:"open"===i?"mdi:window-open":"mdi:window-closed",lock:"locked"===i?"mdi:lock":"mdi:lock-open",media_player:"playing"===i?"mdi:play-circle":"mdi:play-circle-outline",alarm_control_panel:xt(i),camera:"mdi:video",automation:"mdi:robot",script:"mdi:script-text",scene:"mdi:palette",input_boolean:"on"===i?"mdi:check-circle":"mdi:close-circle",person:"mdi:account",device_tracker:"mdi:crosshairs-gps",vacuum:"mdi:robot-vacuum",input_number:"mdi:ray-vertex",input_select:"mdi:format-list-bulleted",timer:"mdi:timer-outline",counter:"mdi:counter",sun:"above_horizon"===i?"mdi:white-balance-sunny":"mdi:weather-night"}[e]||"mdi:help-circle-outline"}function yt(t){return{"clear-night":"mdi:weather-night",cloudy:"mdi:weather-cloudy",fog:"mdi:weather-fog",hail:"mdi:weather-hail",lightning:"mdi:weather-lightning","lightning-rainy":"mdi:weather-lightning-rainy",partlycloudy:"mdi:weather-partly-cloudy",pouring:"mdi:weather-pouring",rainy:"mdi:weather-rainy",snowy:"mdi:weather-snowy","snowy-rainy":"mdi:weather-snowy-rainy",sunny:"mdi:weather-sunny",windy:"mdi:weather-windy","windy-variant":"mdi:weather-windy-variant",exceptional:"mdi:alert-circle-outline"}[t]||"mdi:weather-cloudy"}function _t(t){return{temperature:"mdi:thermometer",humidity:"mdi:water-percent",pressure:"mdi:gauge",power:"mdi:flash",energy:"mdi:lightning-bolt",battery:"mdi:battery",illuminance:"mdi:brightness-6",carbon_dioxide:"mdi:molecule-co2",carbon_monoxide:"mdi:molecule-co",gas:"mdi:gas-cylinder",moisture:"mdi:water",signal_strength:"mdi:wifi",voltage:"mdi:sine-wave",current:"mdi:current-ac"}[t.attributes.device_class]||"mdi:eye"}function xt(t){return{armed_home:"mdi:shield-home",armed_away:"mdi:shield-lock",armed_night:"mdi:shield-moon",armed_vacation:"mdi:shield-airplane",armed_custom_bypass:"mdi:shield-star",disarmed:"mdi:shield-off",triggered:"mdi:bell-ring",pending:"mdi:shield-alert",arming:"mdi:shield-outline"}[t]||"mdi:shield"}function wt(t){return["on","open","playing","home","unlocked"].includes(t)}function $t(t){const e=t.state,i=t.attributes.unit_of_measurement;return i?`${e} ${i}`:e}t([mt({attribute:!1})],bt.prototype,"hass",void 0),t([gt()],bt.prototype,"_config",void 0);class Ct extends lt{constructor(){super(...arguments),this._config={}}static{this.styles=[n`
  ...
  `]}setConfig(t){this._config={...t}}_computeLabel(t){return{entity:"Entity",name:"Name (optional)",icon:"Icon (optional)",show_name:"Show Name",show_state:"Show State",show_icon:"Show Icon",show_brightness:"Show Brightness Slider",show_color_temp:"Show Color Temperature",show_current_as_primary:"Show Current Temp as Primary",show_forecast:"Show Forecast",num_forecasts:"Number of Forecast Days",graph:"Show Graph",show_artwork:"Show Artwork",show_source:"Show Source",show_position:"Show Position Slider",show_tilt:"Show Tilt Slider",show_location:"Show Location",show_battery:"Show Battery",battery_entity:"Battery Entity",show_controls:"Show Controls",aspect_ratio:"Aspect Ratio",hide_icon:"Hide Icon",states:"Alarm States",mode:"Display Mode",show_date:"Show Date",show_seconds:"Show Seconds",hash:"Hash (e.g. kitchen)",auto_close:"Auto-close (seconds)",width:"Width (e.g. 90%)",style:"Style",columns:"Columns",collapsible:"Collapsible",tap_action:"Tap Action",hold_action:"Hold Action",double_tap_action:"Double Tap Action"}[t.name]||t.name}_valueChanged(t){t.stopPropagation();const e={...this._config,...t.detail.value};e.type=this._config.type,this._config=e,this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:e},bubbles:!0,composed:!0}))}render(){return this.hass&&this._config?Q`
      ...
      ></ha-form>
    `:V}}function St(t){return[{name:"entity",selector:{entity:t?{domain:t}:{}}},{type:"grid",schema:[{name:"name",selector:{text:{}}},{name:"icon",selector:{icon:{}}}]},{name:"show_name",selector:{boolean:{}}},{name:"show_state",selector:{boolean:{}}},{name:"show_icon",selector:{boolean:{}}}]}t([mt({attribute:!1})],Ct.prototype,"hass",void 0),t([gt()],Ct.prototype,"_config",void 0);let Et=class extends Ct{get _schema(){return[...St()]}};Et=t([dt("sketch-entity-card-editor")],Et);let At=class extends bt{static{this.styles=[...super.styles,n`
      .entity-row {
        display: flex;
        align-items: center;
        gap: 14px;
    ...
    `]}setConfig(t){if(!t.entity)throw new Error("Please define an entity");super.setConfig(t)}static getConfigElement(){return document.createElement("sketch-entity-card-editor")}static getStubConfig(t){return{entity:Object.keys(t.states)[0]||"light.example"}}getCardSize(){return 2}render(){const t=this.getEntity();if(!t)return Q`<ha-card><div class="sketch-card-content"><p class="sketch-name">Entity not found</p></div></ha-card>`;const e=this._config.icon||kt(t),i=this.getName(),s=$t(t),a=!1!==this._config.show_name,r=!1!==this._config.show_state,n=!1!==this._config.show_icon,o=wt(t.state);return Q`
      <ha-card>
    ...
    `}};At=t([dt("sketch-entity-card")],At);let Pt=class extends Ct{get _schema(){return[...St()]}};Pt=t([dt("sketch-button-card-editor")],Pt);let zt=class extends bt{constructor(){super(...arguments),this._pressing=!1}static{this.styles=[...super.styles,n`
      .button-wrap {
        display: flex;
        flex-direction: column;
        align-items: center;
    ...
    `}};t([gt()],zt.prototype,"_pressing",void 0),zt=t([dt("sketch-button-card")],zt);let Tt=class extends Ct{get _schema(){return[...St("light"),{name:"show_brightness",selector:{boolean:{}}},{name:"show_color_temp",selector:{boolean:{}}}]}};Tt=t([dt("sketch-light-card-editor")],Tt);let Mt=class extends bt{static{this.styles=[...super.styles,n`
      .light-header {
        display: flex;
        align-items: center;
        gap: 12px;
    ...
    `}};Mt=t([dt("sketch-light-card")],Mt);let jt=class extends Ct{get _schema(){return[...St("climate"),{name:"show_current_as_primary",selector:{boolean:{}}}]}};jt=t([dt("sketch-thermostat-card-editor")],jt);let Ut=class extends bt{static{this.styles=[...super.styles,n`
      .thermo-header {
        display: flex;
        align-items: center;
        gap: 12px;
    ...
    `}};Ut=t([dt("sketch-thermostat-card")],Ut);let Ht=class extends Ct{get _schema(){return[...St("weather"),{name:"show_forecast",selector:{boolean:{}}},{name:"num_forecasts",selector:{number:{min:1,max:7,mode:"box"}}}]}};Ht=t([dt("sketch-weather-card-editor")],Ht);let Ot=class extends bt{static{this.styles=[...super.styles,n`
      .weather-main {
        display: flex;
        align-items: center;
        gap: 16px;
    ...
    `}};Ot=t([dt("sketch-weather-card")],Ot);let Lt=class extends Ct{get _schema(){return[...St("sensor"),{name:"graph",selector:{boolean:{}}}]}};Lt=t([dt("sketch-sensor-card-editor")],Lt);let Nt=class extends bt{constructor(){super(...arguments),this._history=[]}static{this.styles=[...super.styles,n`
      .sensor-header {
        display: flex;
    ...
    `}};t([gt()],Nt.prototype,"_history",void 0),Nt=t([dt("sketch-sensor-card")],Nt);let Dt=class extends Ct{get _schema(){return[...St("media_player"),{name:"show_artwork",selector:{boolean:{}}},{name:"show_source",selector:{boolean:{}}}]}};Dt=t([dt("sketch-media-player-card-editor")],Dt);let It=class extends bt{static{this.styles=[...super.styles,n`
      .media-layout {
        display: flex;
        gap: 14px;
        align-items: center;
    ...
    `}};It=t([dt("sketch-media-player-card")],It);let Rt=class extends Ct{get _schema(){return[...St("cover"),{name:"show_position",selector:{boolean:{}}},{name:"show_tilt",selector:{boolean:{}}}]}};Rt=t([dt("sketch-cover-card-editor")],Rt);let Bt=class extends bt{static{this.styles=[...super.styles,n`
      .cover-header {
        display: flex;
        align-items: center;
        gap: 12px;
    ...
    `}};Bt=t([dt("sketch-cover-card")],Bt);let Wt=class extends Ct{get _schema(){return[...St("alarm_control_panel"),{name:"states",selector:{select:{multiple:!0,options:[{value:"arm_home",label:"Arm Home"},{value:"arm_away",label:"Arm Away"},{value:"arm_night",label:"Arm Night"},{value:"arm_custom_bypass",label:"Arm Custom"}]}}}]}};Wt=t([dt("sketch-alarm-panel-card-editor")],Wt);let Qt=class extends bt{constructor(){super(...arguments),this._code=""}static{this.styles=[...super.styles,n`
      .alarm-header {
        display: flex;
        align-items: center;
        gap: 12px;
    ...
    `}};t([gt()],Qt.prototype,"_code",void 0),Qt=t([dt("sketch-alarm-panel-card")],Qt);let qt=class extends Ct{get _schema(){return[{name:"name",selector:{text:{}}},{name:"mode",selector:{select:{options:[{value:"both",label:"Analog + Digital"},{value:"analog",label:"Analog Only"},{value:"digital",label:"Digital Only"}],mode:"dropdown"}}},{name:"show_date",selector:{boolean:{}}},{name:"show_seconds",selector:{boolean:{}}}]}};qt=t([dt("sketch-clock-card-editor")],qt);let Ft=class extends lt{constructor(){super(...arguments),this._time=new Date}static{this.styles=[ft,n`
      .clock-content {
        display: flex;
        flex-direction: column;
        align-items: center;
    ...
    `}};t([gt()],Ft.prototype,"_config",void 0),t([gt()],Ft.prototype,"_time",void 0),Ft=t([dt("sketch-clock-card")],Ft);let Vt=class extends lt{constructor(){super(...arguments),this._config={}}static{this.styles=n`
    :host { display: block; }
    .editor-note {
      font-size: 13px;
      color: var(--secondary-text-color);
  ...
  `}setConfig(t){this._config={...t}}render(){return Q`
    ...
    `}};t([mt({attribute:!1})],Vt.prototype,"hass",void 0),t([gt()],Vt.prototype,"_config",void 0),Vt=t([dt("sketch-chip-card-editor")],Vt);let Kt=class extends lt{static{this.styles=[ft,n`
      :host {
        display: block;
      }
      ha-card {
    ...
    `:V}};t([mt({attribute:!1})],Kt.prototype,"hass",void 0),t([gt()],Kt.prototype,"_config",void 0),Kt=t([dt("sketch-chip-card")],Kt);let Yt=class extends Ct{get _schema(){return[...St("person"),{name:"show_location",selector:{boolean:{}}},{name:"show_battery",selector:{boolean:{}}},{name:"battery_entity",selector:{entity:{domain:"sensor"}}}]}};Yt=t([dt("sketch-person-card-editor")],Yt);let Zt=class extends bt{static{this.styles=[...super.styles,n`
      .person-row {
        display: flex;
        align-items: center;
        gap: 14px;
    ...
    `}};Zt=t([dt("sketch-person-card")],Zt);let Gt=class extends Ct{get _schema(){return[...St(),{name:"hide_icon",selector:{boolean:{}}}]}};Gt=t([dt("sketch-tile-card-editor")],Gt);let Jt=class extends bt{static{this.styles=[...super.styles,n`
      ha-card {
        rotate: -0.3deg;
      }
      .tile-row {
    ...
    `}};Jt=t([dt("sketch-tile-card")],Jt);let Xt=class extends Ct{get _schema(){return[...St("camera"),{name:"show_controls",selector:{boolean:{}}},{name:"aspect_ratio",selector:{text:{}}}]}};Xt=t([dt("sketch-camera-card-editor")],Xt);let te=class extends bt{constructor(){super(...arguments),this._imageUrl="",this._loading=!0}static{this.styles=[...super.styles,n`
      .camera-wrap {
        position: relative;
        overflow: hidden;
    ...
    `}};t([gt()],te.prototype,"_imageUrl",void 0),t([gt()],te.prototype,"_loading",void 0),te=t([dt("sketch-camera-card")],te);let ee=class extends Ct{get _schema(){return[{name:"hash",selector:{text:{}}},{type:"grid",schema:[{name:"name",selector:{text:{}}},{name:"icon",selector:{icon:{}}}]},{name:"auto_close",selector:{number:{min:0,max:300,mode:"box"}}},{name:"width",selector:{text:{}}}]}render(){return this.hass&&this._config?Q`
      ${super.render()}
      <p class="editor-note">
        Configure child cards in YAML mode (code editor).
      </p>
    `:V}};ee=t([dt("sketch-popup-card-editor")],ee);let ie=class extends lt{constructor(){super(...arguments),this._open=!1,this._childCards=[],this._hashListener=()=>this._checkHash(),this._keyListener=t=>{"Escape"===t.key&&this._open&&this._closePopup()}}static{this.styles=[ft,n`
      :host {
        display: block;
      }
    ...
    `}};t([mt({attribute:!1})],ie.prototype,"hass",void 0),t([gt()],ie.prototype,"_config",void 0),t([gt()],ie.prototype,"_open",void 0),t([gt()],ie.prototype,"_childCards",void 0),ie=t([dt("sketch-popup-card")],ie);let se=class extends lt{constructor(){super(...arguments),this._config={}}static{this.styles=n`
    :host { display: block; }
    .editor-note {
      font-size: 13px;
      color: var(--secondary-text-color);
  ...
  `}setConfig(t){this._config={...t}}render(){return Q`
    ...
    `}};t([mt({attribute:!1})],se.prototype,"hass",void 0),t([gt()],se.prototype,"_config",void 0),se=t([dt("sketch-horizontal-buttons-stack-editor")],se);let ae=class extends lt{constructor(){super(...arguments),this._activeHash="",this._hashListener=()=>this._updateActiveHash()}static{this.styles=[ft,n`
      :host {
        display: block;
      }
      .nav-fixed {
    ...
    `}};t([mt({attribute:!1})],ae.prototype,"hass",void 0),t([gt()],ae.prototype,"_config",void 0),t([gt()],ae.prototype,"_activeHash",void 0),ae=t([dt("sketch-horizontal-buttons-stack")],ae);let re=class extends Ct{get _schema(){return[...St(),{name:"columns",selector:{number:{min:1,max:6,mode:"box"}}},{name:"collapsible",selector:{boolean:{}}}]}render(){return this.hass&&this._config?Q`
      ${super.render()}
      <p class="editor-note">
        Configure sub_buttons in YAML mode (code editor).
      </p>
    `:V}};re=t([dt("sketch-sub-button-card-editor")],re);let ne=class extends bt{constructor(){super(...arguments),this._expanded=!0}static{this.styles=[...super.styles,n`
      .primary-row {
        display: flex;
        align-items: center;
        gap: 12px;
    ...
    `}};t([gt()],ne.prototype,"_expanded",void 0),ne=t([dt("sketch-sub-button-card")],ne);let oe=class extends Ct{get _schema(){return[{name:"name",selector:{text:{}}},{name:"icon",selector:{icon:{}}}]}};oe=t([dt("sketch-separator-card-editor")],oe);let ce=class extends lt{static{this.styles=[ft,n`
      :host {
        display: block;
      }
      ha-card {
