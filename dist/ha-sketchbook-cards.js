...
`,we=document.createElement("link");function xe(e,t){t?.color?e.style.setProperty("--sketch-primary",t.color):e.style.removeProperty("--sketch-primary"),t?.card_background?e.style.setProperty("--sketch-card-bg",t.card_background):e.style.removeProperty("--sketch-card-bg"),t?.border_color?e.style.setProperty("--sketch-border-color",t.border_color):e.style.removeProperty("--sketch-border-color"),t?.card_rotation?e.style.setProperty("--sketch-card-rotate",t.card_rotation):e.style.removeProperty("--sketch-card-rotate"),null!=t?.corner_radius?e.style.setProperty("--sketch-radius",`${t.corner_radius}px`):e.style.removeProperty("--sketch-radius")}function $e(e){if(e.attributes.icon)return e.attributes.icon;const t=e.entity_id.split(".")[0],i=e.state;return{light:"on"===i?"mdi:lightbulb":"mdi:lightbulb-outline",switch:"on"===i?"mdi:toggle-switch":"mdi:toggle-switch-off",fan:"mdi:fan",climate:"mdi:thermostat",weather:Ce(i),sensor:Se(e),binary_sensor:"on"===i?"mdi:checkbox-marked-circle":"mdi:checkbox-blank-circle-outline",cover:"open"===i?"mdi:window-open":"mdi:window-closed",lock:"locked"===i?"mdi:lock":"mdi:lock-open",media_player:"playing"===i?"mdi:play-circle":"mdi:play-circle-outline",alarm_control_panel:Ee(i),camera:"mdi:video",automation:"mdi:robot",script:"mdi:script-text",scene:"mdi:palette",input_boolean:"on"===i?"mdi:check-circle":"mdi:close-circle",person:"mdi:account",device_tracker:"mdi:crosshairs-gps",vacuum:"mdi:robot-vacuum",input_number:"mdi:ray-vertex",input_select:"mdi:format-list-bulleted",timer:"mdi:timer-outline",counter:"mdi:counter",sun:"above_horizon"===i?"mdi:white-balance-sunny":"mdi:weather-night"}[t]||"mdi:help-circle-outline"}function Ce(e){return{"clear-night":"mdi:weather-night",cloudy:"mdi:weather-cloudy",fog:"mdi:weather-fog",hail:"mdi:weather-hail",lightning:"mdi:weather-lightning","lightning-rainy":"mdi:weather-lightning-rainy",partlycloudy:"mdi:weather-partly-cloudy",pouring:"mdi:weather-pouring",rainy:"mdi:weather-rainy",snowy:"mdi:weather-snowy","snowy-rainy":"mdi:weather-snowy-rainy",sunny:"mdi:weather-sunny",windy:"mdi:weather-windy","windy-variant":"mdi:weather-windy-variant",exceptional:"mdi:alert-circle-outline"}[e]||"mdi:weather-cloudy"}function Se(e){return{temperature:"mdi:thermometer",humidity:"mdi:water-percent",pressure:"mdi:gauge",power:"mdi:flash",energy:"mdi:lightning-bolt",battery:"mdi:battery",illuminance:"mdi:brightness-6",carbon_dioxide:"mdi:molecule-co2",carbon_monoxide:"mdi:molecule-co",gas:"mdi:gas-cylinder",moisture:"mdi:water",signal_strength:"mdi:wifi",voltage:"mdi:sine-wave",current:"mdi:current-ac"}[e.attributes.device_class]||"mdi:eye"}function Ee(e){return{armed_home:"mdi:shield-home",armed_away:"mdi:shield-lock",armed_night:"mdi:shield-moon",armed_vacation:"mdi:shield-airplane",armed_custom_bypass:"mdi:shield-star",disarmed:"mdi:shield-off",triggered:"mdi:bell-ring",pending:"mdi:shield-alert",arming:"mdi:shield-outline"}[e]||"mdi:shield"}function Ae(e){return["on","open","playing","home","unlocked"].includes(e)}function ze(e,t){if(t?.formatEntityState)try{return t.formatEntityState(e)}catch(e){}const i=e.state,s=e.attributes.unit_of_measurement;return s?`${i} ${s}`:i}function Pe(e,t,i){return Math.min(Math.max(e,t),i)}function Te(e,t){const i=49297*Math.sin(9301*e+49297*t+233280);return i-Math.floor(i)}function Me(e,t,i,s,o,a,n=4){const r=i-e,c=s-t,l=Math.sqrt(r*r+c*c);if(l<8)return`L ${i.toFixed(1)} ${s.toFixed(1)}`;const h=Math.max(2,Math.floor(l/35));let d="";for(let i=1;i<=h;i++){const s=i/h,p=e+r*s,m=t+c*s;if(i<h){const e=-c/l,t=r/l,s=(Te(o,13*a+i)-.5)*n*2;d+=`L ${(p+e*s).toFixed(1)} ${(m+t*s).toFixed(1)} `}else d+=`L ${p.toFixed(1)} ${m.toFixed(1)} `}return d}function Le(e,t,i,s,o,a=5,n=0,r=0){const c=e+n,l=t+n,h=e+i-n,d=t+s-n,p=Math.min(r,(h-c)/3,(d-l)/3),m=e=>(Te(o,e+50)-.5)*a*.6;if(p<1){let e=`M ${(c+m(0)).toFixed(1)} ${(l+m(1)).toFixed(1)} `;return e+=Me(c+m(0),l+m(1),h+m(2),l+m(3),o,0,a),e+=Me(h+m(2),l+m(3),h+m(4),d+m(5),o,1,a),e+=Me(h+m(4),d+m(5),c+m(6),d+m(7),o,2,a),e+=Me(c+m(6),d+m(7),c+m(0),l+m(1),o,3,a),e+="Z",e}const u=e=>(Te(o,e+80)-.5)*a*.3;let g=`M ${(c+p+u(0)).toFixed(1)} ${(l+u(1)).toFixed(1)} `;return g+=Me(c+p+u(0),l+u(1),h-p+u(2),l+u(3),o,0,a),g+=`Q ${(h+u(4)).toFixed(1)} ${(l+u(5)).toFixed(1)} ${(h+u(6)).toFixed(1)} ${(l+p+u(7)).toFixed(1)} `,g+=Me(h+u(6),l+p+u(7),h+u(8),d-p+u(9),o,1,a),g+=`Q ${(h+u(10)).toFixed(1)} ${(d+u(11)).toFixed(1)} ${(h-p+u(12)).toFixed(1)} ${(d+u(13)).toFixed(1)} `,g+=Me(h-p+u(12),d+u(13),c+p+u(14),d+u(15),o,2,a),g+=`Q ${(c+u(16)).toFixed(1)} ${(d+u(17)).toFixed(1)} ${(c+u(18)).toFixed(1)} ${(d-p+u(19)).toFixed(1)} `,g+=Me(c+u(18),d-p+u(19),c+u(20),l+p+u(21),o,3,a),g+=`Q ${(c+u(22)).toFixed(1)} ${(l+u(23)).toFixed(1)} ${(c+p+u(0)).toFixed(1)} ${(l+u(1)).toFixed(1)} `,g+="Z",g}function je(e,t,i={}){const{bgColor:s="var(--sketch-card-bg, var(--ha-card-background, #faf7f0))",strokeColor:o="var(--sketch-border-color, var(--primary-text-color, #2a2a2a))",showBorder:a=!0,showTexture:n=!0,noiseOpacity:r=.08,seed:c=0,variant:l="paper",cornerRadius:h=14,active:d=!1}=i,p=h,m=`sn${c}${Math.floor(1e4*Te(c,999))}`;let u=`<svg class="sketch-bg-svg" viewBox="0 0 ${e} ${t}" preserveAspectRatio="none" xmlns="http://www.w3.org/2000/svg">`;n&&(u+=`<defs>\n      <filter id="${m}" x="0" y="0" width="100%" height="100%">\n        <feTurbulence type="fractalNoise" baseFrequency="0.5" numOctaves="4" seed="${c}" stitchTiles="stitch" result="noise"/>\n        <feColorMatrix type="saturate" values="0" in="noise" result="gray"/>\n      </filter>\n    </defs>`);const g=Le(0,0,e,t,c,3,3,p);u+=`<path d="${g}" fill="${s}" />`,d&&(u+=`<path d="${g}" fill="var(--sketch-active, var(--sketch-primary, #4a6fa5))" opacity="0.10" />`),n&&(u+=`<rect x="0" y="0" width="${e}" height="${t}" filter="url(#${m})" opacity="${r}" style="mix-blend-mode:multiply" />`),"notebook"===l?u+=function(e,t,i){let s="";const o=28,a=50;for(let i=45;i<t-15;i+=o){const t=.5*Math.sin(.1*i);s+=`<line x1="${a+5}" y1="${i+t}" x2="${e-15}" y2="${i-.5*t}" stroke="#90c1d4" stroke-width="0.8" opacity="0.35" />`}s+=`<line x1="${a}" y1="8" x2="${a+.5}" y2="${t-8}" stroke="#d4626a" stroke-width="1.8" opacity="0.35" />`,s+=`<line x1="${a+2.5}" y1="8" x2="${a+2}" y2="${t-8}" stroke="#d4626a" stroke-width="0.8" opacity="0.18" />`;const n=Math.min(6,Math.floor((t-40)/45));for(let e=0;e<n;e++){const t=35+45*e;s+=`<circle cx="22" cy="${t}" r="5" fill="var(--sketch-card-bg, var(--ha-card-background, #faf7f0))" />`,s+=`<circle cx="22" cy="${t}" r="5" fill="none" stroke="${i}" stroke-width="1.2" opacity="0.3" />`,s+=`<circle cx="22.5" cy="${t+.5}" r="4" fill="none" stroke="${i}" stroke-width="0.5" opacity="0.15" />`}return s}(e,t,o):"sticky"===l&&(u+=function(e){const t=e/2,i=Math.min(90,.3*e);return`<g opacity="0.55" transform="rotate(${(2*Math.sin(.1*t)-1).toFixed(1)} ${t} 6)">\n    <rect x="${t-i/2}" y="-4" width="${i}" height="20" fill="#e8e4c8" rx="1" />\n    <line x1="${t-i/2+4}" y1="2" x2="${t+i/2-4}" y2="2" stroke="#c8c4a8" stroke-width="0.4" opacity="0.4" />\n    <line x1="${t-i/2+4}" y1="8" x2="${t+i/2-4}" y2="8" stroke="#c8c4a8" stroke-width="0.4" opacity="0.4" />\n  </g>`}(e));const f=d?"var(--sketch-active, var(--sketch-primary, #4a6fa5))":o;if(a){u+=`<path d="${Le(0,0,e,t,c,5,6,p)}" fill="none" stroke="${f}" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round" opacity="${d?"0.75":"0.65"}" />`;u+=`<path d="${Le(0,0,e,t,c+17,4,7.8,p)}" fill="none" stroke="${f}" stroke-width="1.0" stroke-linecap="round" stroke-linejoin="round" opacity="${d?"0.30":"0.22"}" />`}const v=Math.max(10,.07*Math.min(e,t)),_=11+2*Te(c,70),k=11+2*Te(c,71);u+=`<line x1="${_-.4*v}" y1="${k}" x2="${_+.4*v}" y2="${k}" stroke="${o}" stroke-width="1.2" opacity="0.3" stroke-linecap="round"/>`,u+=`<line x1="${_}" y1="${k-.4*v}" x2="${_}" y2="${k+.4*v}" stroke="${o}" stroke-width="1.2" opacity="0.3" stroke-linecap="round"/>`;const y=e-6-7+2*Te(c,72),b=t-6-7+2*Te(c,73),w=.35*v;u+=`<circle cx="${y}" cy="${b}" r="${w}" fill="none" stroke="${o}" stroke-width="1.1" opacity="0.28" />`,u+=`<path d="M ${y-.8*w} ${b-.3*w} A ${w} ${w} 0 0 1 ${y+.5*w} ${b+.8*w}" fill="none" stroke="${o}" stroke-width="0.7" opacity="0.18" />`;const x=Math.min(18,.045*e,.09*t),$=e-6-x;return u+=`<path d="M ${$} 6 L ${e-6} 6 L ${e-6} ${6+x} Z" fill="${o}" opacity="0.05" />`,u+=`<line x1="${$}" y1="6" x2="${e-6}" y2="${6+x}" stroke="${o}" stroke-width="0.8" opacity="0.18" stroke-linecap="round"/>`,u+="</svg>",u}function Oe(e){window.dispatchEvent(new CustomEvent("haptic",{detail:e}))}we.rel="stylesheet",we.href="https://fonts.googleapis.com/css2?family=Caveat:wght@400;600;700&family=Patrick+Hand&display=swap",document.head.querySelector('link[href*="Caveat"]')||document.head.appendChild(we);class Ne extends le{constructor(){super(...arguments),this._holdFired=!1,this._lastTap=0,this._prevState="",this.handleKeyDown=e=>{"Enter"!==e.key&&" "!==e.key||(e.preventDefault(),this.executeAction(this._config?.tap_action,this.defaultTapAction))},this.handlePointerDown=e=>{this._holdFired=!1,this._holdTimer=setTimeout(()=>{this._holdFired=!0,this._config?.hold_action&&(this.executeAction(this._config.hold_action),Oe("medium"))},500)},this.handlePointerUp=e=>{if(this._holdTimer&&(clearTimeout(this._holdTimer),this._holdTimer=void 0),this._holdFired)return;const t=Date.now();this._config?.double_tap_action&&t-this._lastTap<250?(this._dblTapTimer&&(clearTimeout(this._dblTapTimer),this._dblTapTimer=void 0),this._lastTap=0,this.executeAction(this._config.double_tap_action)):(this._lastTap=t,this._config?.double_tap_action?this._dblTapTimer=setTimeout(()=>{this._lastTap=0,this.executeAction(this._config?.tap_action,this.defaultTapAction)},250):this.executeAction(this._config?.tap_action,this.defaultTapAction))},this.handlePointerCancel=()=>{this._holdTimer&&(clearTimeout(this._holdTimer),this._holdTimer=void 0),this._holdFired=!1}}static{this.styles=[be]}setConfig(e){if(!e)throw new Error("Invalid configuration");this._config={...e}}getCardSize(){return 3}renderSketchBg(e=400,t=200,i=!1){const s=this._config;let o=0;const a=this._config?.entity||"";for(let e=0;e<a.length;e++)o=(o<<5)-o+a.charCodeAt(e)|0;return o=Math.abs(o),W`${ye(je(e,t,{showBorder:!1!==s?.show_border,showTexture:!1!==s?.show_texture,variant:s?.variant||"paper",cornerRadius:s?.corner_radius??14,active:i,seed:o}))}`}getLayoutOptions(){return{grid_columns:4,grid_rows:this.getCardSize()}}getEntity(){if(this._config?.entity&&this.hass)return this.hass.states[this._config.entity]}isUnavailable(){const e=this.getEntity();return!!e&&["unavailable","unknown"].includes(e.state)}getName(){if(this._config?.name)return this._config.name;const e=this.getEntity();return e?.attributes?.friendly_name||this._config?.entity||""}getIcon(){if(this._config?.icon)return this._config.icon;const e=this.getEntity();return e?.attributes?.icon||"mdi:help-circle-outline"}async callService(e,t,i){try{await this.hass.callService(e,t,i)}catch(e){this.classList.add("sketch-error"),setTimeout(()=>this.classList.remove("sketch-error"),1e3),console.error("Ha-sketch service call failed:",e)}}toggleEntity(){if(!this._config?.entity)return;const[e]=this._config.entity.split(".");this.callService(e,"toggle",{entity_id:this._config.entity})}fireEvent(e,t){this.dispatchEvent(new CustomEvent(e,{bubbles:!0,composed:!0,detail:t}))}executeAction(e,t="more-info"){if(e?.confirmation&&!window.confirm("Are you sure?"))return;switch(e?.action||t){case"toggle":this.toggleEntity(),Oe("success");break;case"call-service":if(e?.service){const[t,i]=e.service.split(".");this.callService(t,i,e.service_data),Oe("light")}break;case"navigate":e?.navigation_path&&/^\/[a-zA-Z0-9\-_/?#=&.]*$/.test(e.navigation_path)&&(window.history.pushState(null,"",e.navigation_path),this.fireEvent("location-changed"),Oe("light"));break;case"url":e?.url_path&&(window.open(e.url_path,"_blank"),Oe("light"));break;case"none":break;default:this.fireEvent("hass-more-info",{entityId:this._config?.entity}),Oe("light")}}updated(e){if(super.updated(e),e.has("_config")&&xe(this,this._config),e.has("hass")&&this.hass){const e=this.hass.themes?.darkMode??!1;this.classList.toggle("dark-mode",e);const t=this.isUnavailable();t&&!this.classList.contains("unavailable")?this.classList.add("unavailable"):!t&&this.classList.contains("unavailable")&&this.classList.remove("unavailable");const i=this.getEntity();if(i&&this._prevState&&i.state!==this._prevState){const e=this.shadowRoot?.querySelector("ha-card");e&&(e.style.animation="none",e.offsetHeight,e.style.animation="sketch-state-pulse 0.6s ease")}i&&(this._prevState=i.state)}}disconnectedCallback(){super.disconnectedCallback(),this._holdTimer&&clearTimeout(this._holdTimer),this._dblTapTimer&&clearTimeout(this._dblTapTimer)}get defaultTapAction(){return"more-info"}handleAction(){this.executeAction(this._config?.tap_action,this.defaultTapAction)}}e([ue({attribute:!1})],Ne.prototype,"hass",void 0),e([ge()],Ne.prototype,"_config",void 0);class De extends le{constructor(){super(...arguments),this._computeLabel=e=>({entity:"Entity",name:"Name (optional)",icon:"Icon (optional)",show_name:"Show Name",show_state:"Show State",show_icon:"Show Icon",show_brightness:"Show Brightness Slider",show_color_temp:"Show Color Temperature",show_current_as_primary:"Show Current Temp as Primary",show_forecast:"Show Forecast",num_forecasts:"Number of Forecast Days",graph:"Show Graph",show_artwork:"Show Artwork",show_source:"Show Source",show_position:"Show Position Slider",show_tilt:"Show Tilt Slider",show_location:"Show Location",show_battery:"Show Battery",battery_entity:"Battery Entity",show_controls:"Show Controls",aspect_ratio:"Aspect Ratio",hide_icon:"Hide Icon",states:"Alarm States",mode:"Display Mode",show_date:"Show Date",show_seconds:"Show Seconds",hash:"Hash (e.g. kitchen)",auto_close:"Auto-close (seconds)",width:"Width (e.g. 90%)",style:"Style",columns:"Columns",collapsible:"Collapsible",color:"Accent Color",card_background:"Card Background",border_color:"Border Color",card_rotation:"Rotation (e.g. -1deg, 0deg)",corner_radius:"Corner Roundness",show_border:"Show Border",show_texture:"Show Paper Texture",variant:"Card Style",primary:"Primary Text (template)",secondary:"Secondary Text (template)",icon_color:"Icon Color",layout:"Layout",multiline_secondary:"Multiline Secondary",badge_icon:"Badge Icon",badge_color:"Badge Color",hours_to_show:"Hours to Show",line_width:"Line Width",fill:"Fill Mode",show_labels:"Show Labels",sub_entities:"Sub-Entities",max:"Maximum Value",max_entries:"Max Entries",temperature_entity:"Temperature Sensor",room_select_entity:"Room Selector (input_select)"}[e.name]||e.name),this._valueChanged=e=>{const t=e.detail.value;!function(e,t,i){const s=new Event(t,{bubbles:!0,cancelable:!1,composed:!0});s.detail=i,e.dispatchEvent(s)}(this,"config-changed",{config:{...this._config,...t}})}}static{this.styles=[n`
  ...
  `]}get _defaults(){return{}}setConfig(e){this._config={...this._defaults,...e}}render(){return this.hass&&this._config?W`
      ...
      ></ha-form>
    `:Q}}function Be(e){return[{name:"entity",selector:{entity:e?{domain:e}:{}}},{type:"grid",name:"",schema:[{name:"name",selector:{text:{}}},{name:"icon",selector:{icon:{}},context:{icon_entity:"entity"}}]},{name:"show_name",selector:{boolean:{}}},{name:"show_state",selector:{boolean:{}}},{name:"show_icon",selector:{boolean:{}}},{type:"expandable",title:"Appearance",schema:[{type:"grid",name:"",schema:[{name:"color",selector:{ui_color:{}}},{name:"card_background",selector:{ui_color:{}}}]},{name:"border_color",selector:{ui_color:{}}},{name:"variant",selector:{select:{options:[{value:"paper",label:"Paper (default)"},{value:"notebook",label:"Notebook"},{value:"sticky",label:"Sticky Note"}],mode:"dropdown"}}},{name:"card_rotation",selector:{text:{}}},{name:"corner_radius",selector:{number:{min:0,max:30,step:1,mode:"slider",unit_of_measurement:"px"}}},{name:"show_border",selector:{boolean:{}}},{name:"show_texture",selector:{boolean:{}}}]}]}e([ue({attribute:!1})],De.prototype,"hass",void 0),e([ge()],De.prototype,"_config",void 0);let Ue=class extends De{get _defaults(){return{show_name:!0,show_state:!0,show_icon:!0}}get _schema(){return[...Be()]}};Ue=e([de("sketch-entity-card-editor")],Ue);let He=class extends Ne{static{this.styles=[...super.styles,n`
      .entity-row {
        display: flex;
        align-items: center;
        gap: 14px;
    ...
    `]}setConfig(e){if(!e.entity)throw new Error("Please define an entity");super.setConfig(e)}static getConfigElement(){return document.createElement("sketch-entity-card-editor")}static getStubConfig(e){return{entity:Object.keys(e.states)[0]||"light.example"}}getCardSize(){return 2}render(){const e=this.getEntity();if(!e)return W`<ha-card><div class="sketch-card-content"><p class="sketch-name">Entity not found</p></div></ha-card>`;const t=this._config.icon||$e(e),i=this.getName(),s=ze(e),o=!1!==this._config.show_name,a=!1!==this._config.show_state,n=!1!==this._config.show_icon,r=Ae(e.state);return W`
      <ha-card>
    ...
    `}};He=e([de("sketch-entity-card")],He);let Ie=class extends De{get _defaults(){return{show_name:!0,show_state:!0,show_icon:!0}}get _schema(){return[...Be()]}};Ie=e([de("sketch-button-card-editor")],Ie);let Fe=class extends Ne{constructor(){super(...arguments),this._pressing=!1}static{this.styles=[...super.styles,n`
      .button-wrap {
        display: flex;
        flex-direction: column;
        align-items: center;
    ...
    `}};e([ge()],Fe.prototype,"_pressing",void 0),Fe=e([de("sketch-button-card")],Fe);let Re=class extends De{get _defaults(){return{show_name:!0,show_state:!0,show_icon:!0,show_brightness:!0,show_color_temp:!0}}get _schema(){return[...Be("light"),{name:"show_brightness",selector:{boolean:{}}},{name:"show_color_temp",selector:{boolean:{}}}]}};Re=e([de("sketch-light-card-editor")],Re);let We=class extends Ne{static{this.styles=[...super.styles,n`
      .light-header {
        display: flex;
        align-items: center;
        gap: 12px;
    ...
    `}};We=e([de("sketch-light-card")],We);let Ke=class extends De{get _defaults(){return{show_name:!0,show_state:!0,show_icon:!0,show_current_as_primary:!1}}get _schema(){return[...Be("climate"),{name:"show_current_as_primary",selector:{boolean:{}}}]}};Ke=e([de("sketch-thermostat-card-editor")],Ke);let Ge=class extends Ne{static{this.styles=[...super.styles,n`
      .thermo-header {
        display: flex;
        align-items: center;
        gap: 12px;
    ...
    `}};Ge=e([de("sketch-thermostat-card")],Ge);let Qe=class extends De{get _defaults(){return{show_name:!0,show_state:!0,show_icon:!0,show_forecast:!0,num_forecasts:5}}get _schema(){return[...Be("weather"),{name:"show_forecast",selector:{boolean:{}}},{name:"num_forecasts",selector:{number:{min:1,max:7,mode:"box"}}}]}};Qe=e([de("sketch-weather-card-editor")],Qe);let Ve=class extends Ne{static{this.styles=[...super.styles,n`
      .weather-main {
        display: flex;
        align-items: center;
        gap: 16px;
    ...
    `]}setConfig(e){if(!e.entity)throw new Error("Please define a weather entity");super.setConfig(e)}static getConfigElement(){return document.createElement("sketch-weather-card-editor")}static getStubConfig(e){const t=Object.keys(e.states).filter(e=>e.startsWith("weather."));return{entity:t[0]||"weather.example"}}getCardSize(){const e=this._config;return!1!==e?.show_forecast?5:3}get _weatherConfig(){return this._config}_weatherIconName(e){return function(e){return Ce(e)}(e)}render(){const e=this.getEntity();if(!e)return W`<ha-card><div class="sketch-card-content"><p class="sketch-name">Weather not found</p></div></ha-card>`;const t=e.attributes.temperature??"--",i=e.attributes.temperature_unit||"°",s=e.state,o=e.attributes.humidity,a=e.attributes.wind_speed,n=e.attributes.wind_speed_unit||"km/h",r=e.attributes.pressure,c=e.attributes.forecast||[],l=!1!==this._weatherConfig.show_forecast,h=this._weatherConfig.num_forecasts||5,d=!1!==this._config.show_name,p=!1!==this._config.show_icon;return W`
      <ha-card>
        ${this.renderSketchBg()}
        <div class="sketch-card-content">
    ...
    `}};Ve=e([de("sketch-weather-card")],Ve);let qe=class extends De{get _defaults(){return{show_name:!0,show_state:!0,show_icon:!0,graph:!0}}get _schema(){return[...Be("sensor"),{name:"graph",selector:{boolean:{}}}]}};qe=e([de("sketch-sensor-card-editor")],qe);let Ze=class extends Ne{constructor(){super(...arguments),this._history=[],this._historyEntityId=""}static{this.styles=[...super.styles,n`
      .sensor-header {
        display: flex;
    ...
    `}};e([ge()],Ze.prototype,"_history",void 0),Ze=e([de("sketch-sensor-card")],Ze);let Ye=class extends De{get _defaults(){return{show_name:!0,show_state:!0,show_icon:!0,show_artwork:!0,show_source:!0}}get _schema(){return[...Be("media_player"),{name:"show_artwork",selector:{boolean:{}}},{name:"show_source",selector:{boolean:{}}}]}};Ye=e([de("sketch-media-player-card-editor")],Ye);let Je=class extends Ne{static{this.styles=[...super.styles,n`
      .media-layout {
        display: flex;
        gap: 14px;
        align-items: center;
    ...
    `}};Je=e([de("sketch-media-player-card")],Je);let Xe=class extends De{get _defaults(){return{show_name:!0,show_state:!0,show_icon:!0,show_position:!0,show_tilt:!0}}get _schema(){return[...Be("cover"),{name:"show_position",selector:{boolean:{}}},{name:"show_tilt",selector:{boolean:{}}}]}};Xe=e([de("sketch-cover-card-editor")],Xe);let et=class extends Ne{static{this.styles=[...super.styles,n`
      .cover-header {
        display: flex;
        align-items: center;
        gap: 12px;
    ...
    `}};e([ge()],ot.prototype,"_config",void 0),e([ge()],ot.prototype,"_time",void 0),ot=e([de("sketch-clock-card")],ot);let at=class extends le{constructor(){super(...arguments),this._config={}}static{this.styles=n`
    :host { display: block; }
    .editor-note {
      font-size: 13px;
      color: var(--secondary-text-color);
  ...
  `}setConfig(e){this._config={...e}}render(){return W`
    ...
    `}};e([ue({attribute:!1})],at.prototype,"hass",void 0),e([ge()],at.prototype,"_config",void 0),at=e([de("sketch-chip-card-editor")],at);let nt=class extends le{static{this.styles=[be,n`
      :host {
        display: block;
      }
      ha-card {
    ...
    `:Q}};e([ue({attribute:!1})],nt.prototype,"hass",void 0),e([ge()],nt.prototype,"_config",void 0),nt=e([de("sketch-chip-card")],nt);let rt=class extends De{get _defaults(){return{show_name:!0,show_state:!0,show_icon:!0,show_location:!0,show_battery:!0}}get _schema(){return[...Be("person"),{name:"show_location",selector:{boolean:{}}},{name:"show_battery",selector:{boolean:{}}},{name:"battery_entity",selector:{entity:{domain:"sensor"}}}]}};rt=e([de("sketch-person-card-editor")],rt);let ct=class extends Ne{static{this.styles=[...super.styles,n`
      .person-row {
        display: flex;
        align-items: center;
        gap: 14px;
    ...
    `}};ct=e([de("sketch-person-card")],ct);let lt=class extends De{get _defaults(){return{show_name:!0,show_state:!0,show_icon:!0,hide_icon:!1}}get _schema(){return[...Be(),{name:"hide_icon",selector:{boolean:{}}}]}};lt=e([de("sketch-tile-card-editor")],lt);let ht=class extends Ne{static{this.styles=[...super.styles,n`
      ha-card {
        rotate: -0.3deg;
      }
      .tile-row {
    ...
    `}};ht=e([de("sketch-tile-card")],ht);let dt=class extends De{get _defaults(){return{show_name:!0,show_state:!0,show_icon:!0,show_controls:!0}}get _schema(){return[...Be("camera"),{name:"show_controls",selector:{boolean:{}}},{name:"aspect_ratio",selector:{text:{}}}]}};dt=e([de("sketch-camera-card-editor")],dt);let pt=class extends Ne{constructor(){super(...arguments),this._imageUrl="",this._loading=!0}static{this.styles=[...super.styles,n`
      .camera-wrap {
        position: relative;
        z-index: 1;
        overflow: hidden;
    ...
    `}};e([ge()],pt.prototype,"_imageUrl",void 0),e([ge()],pt.prototype,"_loading",void 0),pt=e([de("sketch-camera-card")],pt);let mt=class extends De{get _schema(){return[{name:"hash",selector:{text:{}}},{type:"grid",name:"",schema:[{name:"name",selector:{text:{}}},{name:"icon",selector:{icon:{}}}]},{name:"auto_close",selector:{number:{min:0,max:300,mode:"box"}}},{name:"width",selector:{text:{}}}]}render(){return this.hass&&this._config?W`
      ${super.render()}
      <p class="editor-note">
        Configure child cards in YAML mode (code editor).
      </p>
    `:Q}};mt=e([de("sketch-popup-card-editor")],mt);let ut=class extends le{constructor(){super(...arguments),this._open=!1,this._childCards=[],this._hashListener=()=>this._checkHash(),this._keyListener=e=>{"Escape"===e.key&&this._open&&this._closePopup()}}static{this.styles=[be,n`
      :host {
        display: block;
      }
    ...
    `}};e([ue({attribute:!1})],ut.prototype,"hass",void 0),e([ge()],ut.prototype,"_config",void 0),e([ge()],ut.prototype,"_open",void 0),e([ge()],ut.prototype,"_childCards",void 0),ut=e([de("sketch-popup-card")],ut);let gt=class extends le{constructor(){super(...arguments),this._config={}}static{this.styles=n`
    :host { display: block; }
    .editor-note {
      font-size: 13px;
      color: var(--secondary-text-color);
  ...
  `}setConfig(e){this._config={...e}}render(){return W`
    ...
    `}};e([ue({attribute:!1})],gt.prototype,"hass",void 0),e([ge()],gt.prototype,"_config",void 0),gt=e([de("sketch-horizontal-buttons-stack-editor")],gt);let ft=class extends le{constructor(){super(...arguments),this._activeHash="",this._hashListener=()=>this._updateActiveHash()}static{this.styles=[be,n`
      :host {
        display: block;
      }
      .nav-fixed {
    ...
    `}};e([ue({attribute:!1})],ft.prototype,"hass",void 0),e([ge()],ft.prototype,"_config",void 0),e([ge()],ft.prototype,"_activeHash",void 0),ft=e([de("sketch-horizontal-buttons-stack")],ft);let vt=class extends De{get _defaults(){return{show_name:!0,show_state:!0,show_icon:!0,columns:3,collapsible:!0}}get _schema(){return[...Be(),{name:"columns",selector:{number:{min:1,max:6,mode:"box"}}},{name:"collapsible",selector:{boolean:{}}}]}render(){return this.hass&&this._config?W`
      ${super.render()}
      <p class="editor-note">
        Configure sub_buttons in YAML mode (code editor).
      </p>
    `:Q}};vt=e([de("sketch-sub-button-card-editor")],vt);let _t=class extends Ne{constructor(){super(...arguments),this._expanded=!0}static{this.styles=[...super.styles,n`
      .primary-row {
        display: flex;
        align-items: center;
        gap: 12px;
    ...
    `}render(){const e=this.getEntity();if(!e)return W`<ha-card><div class="sketch-card-content"><p class="sketch-name">Entity not found</p></div></ha-card>`;const t=this._config.icon||$e(e),i=this.getName(),s=Ae(e.state),o=Math.max(1,Math.min(this._subConfig.columns||3,6)),a=!1!==this._subConfig.collapsible,n=!1!==this._config.show_name,r=!1!==this._config.show_state,c=!1!==this._config.show_icon;return W`
      <ha-card>
        ${this.renderSketchBg(400,200,s)}
        <div class="sketch-card-content">
    ...
    `}};e([ge()],_t.prototype,"_expanded",void 0),_t=e([de("sketch-sub-button-card")],_t);let kt=class extends De{get _schema(){return[{name:"name",selector:{text:{}}},{name:"icon",selector:{icon:{}}},{type:"expandable",title:"Appearance",schema:[{type:"grid",name:"",schema:[{name:"color",selector:{ui_color:{}}},{name:"card_background",selector:{ui_color:{}}}]},{name:"border_color",selector:{ui_color:{}}},{name:"variant",selector:{select:{options:[{value:"paper",label:"Paper (default)"},{value:"notebook",label:"Notebook"},{value:"sticky",label:"Sticky Note"}],mode:"dropdown"}}},{name:"card_rotation",selector:{text:{}}},{name:"corner_radius",selector:{number:{min:0,max:30,step:1,mode:"slider",unit_of_measurement:"px"}}},{name:"show_border",selector:{boolean:{}}},{name:"show_texture",selector:{boolean:{}}}]}]}};kt=e([de("sketch-separator-card-editor")],kt);let yt=class extends le{static{this.styles=[be,n`
      :host {
        display: block;
        overflow: hidden;
      }
    ...
    `}};e([ge()],yt.prototype,"_config",void 0),yt=e([de("sketch-separator-card")],yt);let bt=class extends De{get _defaults(){return{show_name:!0,show_state:!0,show_icon:!0,show_speed:!0}}get _schema(){return[...Be("fan"),{name:"show_speed",selector:{boolean:{}}}]}};bt=e([de("sketch-fan-card-editor")],bt);let wt=class extends Ne{static{this.styles=[...super.styles,n`
      .fan-header {
        display: flex;
        align-items: center;
        gap: 12px;
    ...
    `}};wt=e([de("sketch-fan-card")],wt);let xt=class extends De{get _defaults(){return{show_name:!0,show_state:!0,show_icon:!0}}get _schema(){return[...Be("lock")]}};xt=e([de("sketch-lock-card-editor")],xt);let $t=class extends Ne{static{this.styles=[...super.styles,n`
      .lock-header {
        display: flex;
        align-items: center;
        gap: 12px;
    ...
    `]}setConfig(e){if(!e.entity)throw new Error("Please define a lock entity");super.setConfig(e)}static getConfigElement(){return document.createElement("sketch-lock-card-editor")}static getStubConfig(e){const t=Object.keys(e.states).filter(e=>e.startsWith("lock."));return{entity:t[0]||"lock.example"}}getCardSize(){return 3}_lock(){this.callService("lock","lock",{entity_id:this._config.entity})}_unlock(){this.callService("lock","unlock",{entity_id:this._config.entity})}render(){const e=this.getEntity();if(!e)return W`<ha-card><div class="sketch-card-content"><p class="sketch-name">Lock not found</p></div></ha-card>`;const t="locked"===e.state,i=!1!==this._config.show_name,s=!1!==this._config.show_state,o=!1!==this._config.show_icon,a=this._config.icon||(t?"mdi:lock":"mdi:lock-open");return W`
      <ha-card>
        ${this.renderSketchBg(400,200,t)}
        <div class="sketch-card-content">
    ...
    `}};$t=e([de("sketch-lock-card")],$t);let Ct=class extends De{get _defaults(){return{show_name:!0,show_state:!0,show_icon:!0,show_slider:!0}}get _schema(){return[...Be(),{name:"show_slider",selector:{boolean:{}}}]}};Ct=e([de("sketch-number-card-editor")],Ct);let St=class extends Ne{static{this.styles=[...super.styles,n`
      .number-header {
        display: flex;
        align-items: center;
        gap: 12px;
    ...
    `}_resolveColor(e){return{red:"var(--sketch-danger, #f44336)",green:"var(--sketch-success, #4caf50)",amber:"var(--sketch-warning, #ff9800)",blue:"var(--sketch-primary, #4a6fa5)"}[e]||e}};e([ge()],At.prototype,"_primary",void 0),e([ge()],At.prototype,"_secondary",void 0),e([ge()],At.prototype,"_icon",void 0),e([ge()],At.prototype,"_iconColor",void 0),e([ge()],At.prototype,"_badgeIcon",void 0),At=e([de("sketch-template-card")],At);let zt=class extends De{get _defaults(){return{hours_to_show:24,show_labels:!0,line_width:2,fill:"fade"}}get _schema(){return[{name:"name",selector:{text:{}}},{name:"hours_to_show",selector:{number:{min:1,max:168,step:1,mode:"slider"}}},{name:"line_width",selector:{number:{min:1,max:5,step:.5,mode:"slider"}}},{name:"fill",selector:{select:{options:[{value:"fade",label:"Fade"},{value:"solid",label:"Solid"},{value:"none",label:"None"}],mode:"dropdown"}}},{name:"show_labels",selector:{boolean:{}}},{type:"expandable",title:"Appearance",schema:[{type:"grid",name:"",schema:[{name:"color",selector:{ui_color:{}}},{name:"card_background",selector:{ui_color:{}}}]},{name:"border_color",selector:{ui_color:{}}},{name:"variant",selector:{select:{options:[{value:"paper",label:"Paper (default)"},{value:"notebook",label:"Notebook"},{value:"sticky",label:"Sticky Note"}],mode:"dropdown"}}},{name:"card_rotation",selector:{text:{}}},{name:"corner_radius",selector:{number:{min:0,max:30,step:1,mode:"slider",unit_of_measurement:"px"}}},{name:"show_border",selector:{boolean:{}}},{name:"show_texture",selector:{boolean:{}}}]}]}};zt=e([de("sketch-history-graph-card-editor")],zt);let Pt=class extends le{constructor(){super(...arguments),this._histories=new Map}static{this.styles=[be,n`
      .graph-content {
        position: relative;
        z-index: 1;
        padding: clamp(12px, 3vw, 20px);
    ...
    `}};e([ue({attribute:!1})],Pt.prototype,"hass",void 0),e([ge()],Pt.prototype,"_config",void 0),e([ge()],Pt.prototype,"_histories",void 0),Pt=e([de("sketch-history-graph-card")],Pt);let Tt=class extends De{get _defaults(){return{show_name:!0,show_state:!0,show_icon:!0}}get _schema(){return[...Be("binary_sensor")]}};Tt=e([de("sketch-room-card-editor")],Tt);let Mt=class extends Ne{static{this.styles=[...super.styles,n`
      .room-wrap {
        display: flex;
        align-items: center;
        gap: 14px;
    ...
    `}};Mt=e([de("sketch-room-card")],Mt);let Lt=class extends De{get _defaults(){return{show_name:!0,show_icon:!0}}get _schema(){return[...Be("input_select")]}};Lt=e([de("sketch-select-card-editor")],Lt);let jt=class extends Ne{constructor(){super(...arguments),this._open=!1}static{this.styles=[...super.styles,n`
      .select-header {
        display: flex;
        align-items: center;
        gap: 12px;
    ...
    `}};e([ge()],jt.prototype,"_open",void 0),jt=e([de("sketch-select-card")],jt);let Ot=class extends De{get _defaults(){return{show_name:!0,show_icon:!0,max:100}}get _schema(){return[...Be("sensor"),{name:"max",selector:{number:{min:1,max:1e6,step:1,mode:"box"}}}]}};function Nt(e,t){const i=49297*Math.sin(9301*e+49297*t+233280);return i-Math.floor(i)-.5}Ot=e([de("sketch-progress-card-editor")],Ot);let Dt=class extends Ne{static{this.styles=[...super.styles,n`
      .progress-content {
        display: flex;
        flex-direction: column;
        align-items: center;
    ...
    `}};Dt=e([de("sketch-progress-card")],Dt);let Bt=class extends De{get _defaults(){return{hours_to_show:4,max_entries:8}}get _schema(){return[{name:"name",selector:{text:{}}},{name:"hours_to_show",selector:{number:{min:1,max:48,step:1,mode:"slider"}}},{name:"max_entries",selector:{number:{min:1,max:20,step:1,mode:"slider"}}},{type:"expandable",title:"Appearance",schema:[{type:"grid",name:"",schema:[{name:"color",selector:{ui_color:{}}},{name:"card_background",selector:{ui_color:{}}}]},{name:"border_color",selector:{ui_color:{}}},{name:"variant",selector:{select:{options:[{value:"paper",label:"Paper (default)"},{value:"notebook",label:"Notebook"},{value:"sticky",label:"Sticky Note"}],mode:"dropdown"}}},{name:"card_rotation",selector:{text:{}}},{name:"corner_radius",selector:{number:{min:0,max:30,step:1,mode:"slider",unit_of_measurement:"px"}}},{name:"show_border",selector:{boolean:{}}},{name:"show_texture",selector:{boolean:{}}}]}]}};Bt=e([de("sketch-timeline-card-editor")],Bt);let Ut=class extends le{constructor(){super(...arguments),this._events=[]}static{this.styles=[be,n`
      ha-card {
        overflow: hidden;
      }
      .timeline-content {
          ...
          <div class="tog-clothing">
            ${i.clothing.map((e,t)=>W`
              <div class="tog-clothing-item">
                <svg class="tog-clothing-svg" viewBox="0 0 40 44">${It(function(e,t){const i=(e,t)=>1.5*(49297*Math.sin(9301*e+49297*t)%1-.5);return e.toLowerCase().includes("bodysuit")||e.toLowerCase().includes("vest")?`<path d="M ${20+i(t,0)} ${8+i(t,1)} L ${12+i(t,2)} ${16+i(t,3)} L ${6+i(t,4)} ${14+i(t,5)} L ${10+i(t,6)} ${6+i(t,7)} L ${15+i(t,8)} ${3+i(t,9)} L ${25+i(t,10)} ${3+i(t,11)} L ${30+i(t,12)} ${6+i(t,13)} L ${34+i(t,14)} ${14+i(t,15)} L ${28+i(t,16)} ${16+i(t,17)} L ${20+i(t,18)} ${8+i(t,19)} M ${12+i(t,20)} ${16+i(t,21)} L ${12+i(t,22)} ${34+i(t,23)} L ${17+i(t,24)} ${38+i(t,25)} L ${23+i(t,26)} ${38+i(t,27)} L ${28+i(t,28)} ${34+i(t,29)} L ${28+i(t,30)} ${16+i(t,31)}" fill="none" stroke="var(--sketch-ink, #2a2a2a)" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>`:e.toLowerCase().includes("sleepsuit")||e.toLowerCase().includes("romper")?`<path d="M ${15+i(t,0)} ${4+i(t,1)} L ${25+i(t,2)} ${4+i(t,3)} L ${28+i(t,4)} ${7+i(t,5)} L ${30+i(t,6)} ${18+i(t,7)} L ${30+i(t,8)} ${28+i(t,9)} L ${28+i(t,10)} ${36+i(t,11)} L ${24+i(t,12)} ${38+i(t,13)} L ${22+i(t,14)} ${30+i(t,15)} L ${20+i(t,16)} ${28+i(t,17)} L ${18+i(t,18)} ${30+i(t,19)} L ${16+i(t,20)} ${38+i(t,21)} L ${12+i(t,22)} ${36+i(t,23)} L ${10+i(t,24)} ${28+i(t,25)} L ${10+i(t,26)} ${18+i(t,27)} L ${12+i(t,28)} ${7+i(t,29)} Z" fill="none" stroke="var(--sketch-ink, #2a2a2a)" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>`:e.toLowerCase().includes("sleep bag")||e.toLowerCase().includes("tog")?`<path d="M ${14+i(t,0)} ${6+i(t,1)} C ${14+i(t,2)} ${3+i(t,3)} ${26+i(t,4)} ${3+i(t,5)} ${26+i(t,6)} ${6+i(t,7)} L ${28+i(t,8)} ${12+i(t,9)} L ${30+i(t,10)} ${30+i(t,11)} C ${30+i(t,12)} ${36+i(t,13)} ${26+i(t,14)} ${40+i(t,15)} ${20+i(t,16)} ${40+i(t,17)} C ${14+i(t,18)} ${40+i(t,19)} ${10+i(t,20)} ${36+i(t,21)} ${10+i(t,22)} ${30+i(t,23)} L ${12+i(t,24)} ${12+i(t,25)} Z" fill="none" stroke="var(--sketch-ink, #2a2a2a)" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>`:e.toLowerCase().includes("nappy")?`<path d="M ${12+i(t,0)} ${14+i(t,1)} L ${28+i(t,2)} ${14+i(t,3)} L ${30+i(t,4)} ${22+i(t,5)} C ${30+i(t,6)} ${30+i(t,7)} ${24+i(t,8)} ${34+i(t,9)} ${20+i(t,10)} ${34+i(t,11)} C ${16+i(t,12)} ${34+i(t,13)} ${10+i(t,14)} ${30+i(t,15)} ${10+i(t,16)} ${22+i(t,17)} Z" fill="none" stroke="var(--sketch-ink, #2a2a2a)" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>`:e.toLowerCase().includes("singlet")||e.toLowerCase().includes("thermal")?`<path d="M ${14+i(t,0)} ${6+i(t,1)} L ${16+i(t,2)} ${4+i(t,3)} L ${24+i(t,4)} ${4+i(t,5)} L ${26+i(t,6)} ${6+i(t,7)} L ${26+i(t,8)} ${34+i(t,9)} L ${14+i(t,10)} ${34+i(t,11)} Z M ${16+i(t,12)} ${4+i(t,13)} C ${18+i(t,14)} ${8+i(t,15)} ${22+i(t,16)} ${8+i(t,17)} ${24+i(t,18)} ${4+i(t,19)}" fill="none" stroke="var(--sketch-ink, #2a2a2a)" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>`:`<rect x="${12+i(t,0)}" y="${8+i(t,1)}" width="${16+i(t,2)}" height="${24+i(t,3)}" rx="3" fill="none" stroke="var(--sketch-ink, #2a2a2a)" stroke-width="1.5" stroke-linecap="round"/>`}(e,c+37*t))}</svg>
